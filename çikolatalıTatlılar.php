...
$query = $baglanti->prepare("SELECT urun_adi, urun_bilgi, urun_resmi FROM cikolatali_tatlilar");
$query->execute();
...
<head>
    ...
    <title>🍫 Çikolatalı Tatlılar</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="#">🍫 Çikolatalı Tatlılar</a>
            ...
            <?php else: ?>
                <?php foreach ($urunler as $urun): ?>
                    <div class="col-md-4 py-3">
                        <div class="card">
                            <img src="<?php echo htmlspecialchars($urun['urun_resmi']); ?>" class="card-img-top">
                            <div class="card-body">
